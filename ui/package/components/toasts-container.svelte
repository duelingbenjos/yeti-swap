...
import CloseIcon from "../assets/images/icons/close.svelte";
import PopoutIcon from "../assets/images/icons/popout.svelte";
import GaugePlusIcon from "../assets/images/icons/gauge-plus.svelte";
import GaugeMinusIcon from "../assets/images/icons/gauge-minus.svelte";
const iconMap = {
  popout: PopoutIcon,
